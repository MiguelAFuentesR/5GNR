...
Parameters.Mat_Lineal_BER = [Parameters.Mat_Lineal_BER,Ber_Estimation(Parameters.txbits,Parameters.Lineal_rxbits,Parameters)];
...
Parameters.Mat_Perfect_BER = [Parameters.Mat_Perfect_BER,Ber_Estimation(Parameters.txbits,Parameters.Perfect_rxbits,Parameters)];
...
if Parameters.CNNEstimation
    ...
    Parameters.Mat_CNN_BER = [Parameters.Mat_CNN_BER,Ber_Estimation(Parameters.txbits,Parameters.CNN_rxbits,Parameters)];
...
if Parameters.CNNEstimation_2
    ...
    Parameters.Mat_CNN_2_BER = [Parameters.Mat_CNN_2_BER,Ber_Estimation(Parameters.txbits,Parameters.CNN_2_rxbits,Parameters)];
...
if Parameters.Autoencoder_Estimation
    ...
    Parameters.Mat_Autoencoder_BER = [Parameters.Mat_Autoencoder_BER,Ber_Estimation(Parameters.txbits,Parameters.Autoencoder_rxbits,Parameters)];
...
if Parameters.EstimacionPractica
    ...
    Parameters.Mat_Practical_BER = [Parameters.Mat_Practical_BER,Ber_Estimation(Parameters.txbits,Parameters.Practical_rxbits,Parameters)];
