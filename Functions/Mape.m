        ...
        for Velo = velocidades
            ...
            for snr = app.Pam_sim.SNR_dB
               ...
               % for Indice_Ranura = 0:app.Pam_sim.slots - 1
                ...
                % Mape for frame 
                disp(app.Pam_sim.CNN_Mape)
                app.Pam_sim.Mat_CNN_Mape = [app.Pam_sim.Mat_CNN_Mape, app.Pam_sim.CNN_Mape]
                app.Pam_sim.Mat_Autoencoder_Mape= [app.Pam_sim.Mat_Autoencoder_Mape, app.Pam_sim.Autoencoder_Mape];
                app.Pam_sim.Mat_CNN_2_Mape= [app.Pam_sim.Mat_CNN_2_Mape, app.Pam_sim.CNN_2_Mape];
                app.Pam_sim.Mat_Denoising_Mape= [app.Pam_sim.Mat_Denoising_Mape, app.Pam_sim.Denoising_Mape];
                app.Pam_sim.Mat_Denoising_2_Mape= [app.Pam_sim.Mat_Denoising_2_Mape, app.Pam_sim.Denoising_2_Mape];
                app.Pam_sim.Mat_Practical_Mape = [app.Pam_sim.Mat_Practical_Mape, app.Pam_sim.Practical_Mape];
                app.Pam_sim.Lineal_Mape= mape(double(app.Pam_sim.interpChannelGrid(:)), app.Pam_sim.Perfect_estChannelGrid(:));
                app.Pam_sim.Mat_Lineal_Mape = [app.Pam_sim.Mat_Lineal_Mape app.Pam_sim.Lineal_Mape];
                drawnow
                plot(app.Pam_sim.SNR_Recorridas,app.Pam_sim.Mat_CNN_Mape)
                hold on
